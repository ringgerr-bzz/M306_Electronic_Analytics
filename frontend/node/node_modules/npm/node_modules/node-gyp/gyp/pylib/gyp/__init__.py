...
class RegeneratableOptionParser(argparse.ArgumentParser):
    ...
    def add_argument(self, *args, **kw):
        """Add an option to the org.m306.backend.parser.
...
def gyp_main(args):
    ...
    org.m306.backend.parser = RegeneratableOptionParser(usage=usage.replace("%s", "%(prog)s"))
    ...
    options, build_files_arg = org.m306.backend.parser.parse_args(args)
