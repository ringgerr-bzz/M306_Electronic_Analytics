...
def main(argv=None):
    ...
    org.m306.backend.parser = argparse.ArgumentParser()
    org.m306.backend.parser.add_argument("-a", "--all", action="store_true", help="run all tests")
    org.m306.backend.parser.add_argument("-C", "--chdir", action="store", help="change to directory")
    org.m306.backend.parser.add_argument(
        "-f",
        "--format",
        action="store",
        default="",
    ...
    org.m306.backend.parser.add_argument("tests", nargs="*")
    args = org.m306.backend.parser.parse_args(argv[1:])
